...
function Barnacles(options) {
  ...
  this.eventsManager.on('event', function(event) {
 ...
 * @param {Object} barnowl The barnowl instance providing the data source.
 */
Barnacles.prototype.bind = function(barnowl) {
  var self = this;

  barnowl.on('visibilityEvent', function(tiraid) {
