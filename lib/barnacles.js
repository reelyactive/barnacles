...
class Barnacles extends EventEmitter {
  ...
  /**
   * Retrieve the list of active devices.
   * @param {callback} callback Function to call on completion.
   */
  retrieveDevices(callback) {
    this.store.retrieveDevices(callback);
  }
   ...
   * @param {callback} callback Function to call on completion.
   */
  retrieveDevice(deviceId, deviceIdType, properties, callback) {
    this.store.retrieveDevice(deviceId, deviceIdType, properties, callback);
  }
